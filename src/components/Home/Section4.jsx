    ...
    <>
      ...
      <div className=' flex flex-wrap justify-between mx-14 '>
        ...
        {/* <div className=' ml-100 h-601  w-640 top-4561 gap-80 mt-12' > */}
          {/* <h2 className='font-bold text-4xl  p-8 font-roboto'>We have a Creative Team Discover  <br />
            our experts</h2>

          <p style={{ color: "#75706D", padding: "8px", marginLeft: "35px", fontSize: "20px" }}>Create some exclusive way to solve our customer problems</p>

          <h1 className='font-bold text-2xl p-10'>Our team has expertise with UI/UX designing which can <br />
